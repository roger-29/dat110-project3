...
public class TestConcurrentReadWriteConsistencyPass {
	...
	public void test() throws RemoteException, InterruptedException {
		...
		// GOAL: A write/read operation must not leave the distributed data store in an
		// inconsistent state
	...
	class client1 extends Thread {
		...
		public void run() {
			try {
				...
				boolean decision = recprocess.requestWriteOperation(wmessage); // send a write request and get the
																				// voters decision
